...
<ul class="navbar-nav bg-light px-3 text-center" style="height:100vh">
    ...
    <li class="nav-item" ><a class="nav-link" href="profile.php?pending_order"><h5>Pending Orders</h5></a></li>
    <li class="nav-item" ><a class="nav-link" href="#"><h5>Edit Account</h5></a></li>
    <li class="nav-item" ><a class="nav-link" href="#"><h5>My Orders</h5></a></li>
    <li class="nav-item" ><a class="nav-link" href="#"><h5>Delete Account</h5></a></li>
    <li class="nav-item" ><a class="nav-link" href="#"><h5>Logout</h5></a></li>
</ul>
